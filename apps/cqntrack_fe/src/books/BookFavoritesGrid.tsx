...
import styles from "./BookFavoritesGrid.module.css";
...
// própria tela de detalhe do livro (botão de coração), não mais aqui.
export function BookFavoritesGrid() {
  ...
  if (data.items.length === 0) {
    return <p className={styles.hint}>Nenhum livro favoritado ainda.</p>;
  }
