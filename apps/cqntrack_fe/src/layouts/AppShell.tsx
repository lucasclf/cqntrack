...
// Casca da área autenticada: barra superior (logo, seções, busca contextual,
// conta) — antes era sidebar (desktop) / abas no rodapé (mobile); agora é
// uma barra horizontal só, com os itens que não cabem virando ícones em
// telas estreitas.
            ...
            {MEDIA_TYPES.map((mediaType) => {
              ...
              return (
                <NavLink
                  ...
                  className={isActive ? `${styles.mediaLink} ${styles.mediaLinkActive}` : styles.mediaLink}
                >
