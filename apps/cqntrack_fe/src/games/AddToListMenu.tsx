...
// Dropdown simples pra adicionar o jogo a uma das listas do usuário. Não
// mostra em quais listas o jogo já está (não existe endpoint pra isso ainda);
// só marca com ✓ as listas em que o clique nesta sessão já confirmou a
// adição — adicionar de novo é idempotente no backend de qualquer forma.
export function AddToListMenu({ igdbId }: AddToListMenuProps) {
